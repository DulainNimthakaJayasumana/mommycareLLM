...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text(
        "Send your question in English or Sinhala. I'll reply with supportive, accurate information along with source references and a disclaimer."
    )
